...
def regedity_funkcje():
    ...
    commands = [
        ...
        'reg add "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Services\Tcpip\Parameters\NsiObjectSecurity" /f',
        ...
        'reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Narrator" /v "NarratorOn" /t REG_DWORD /d 0 /f0',
        ...
        'reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Policies\Microsoft\Windows\WindowsUpdate\AU" /v "NoAutoUpdate" /t REG_DWORD /d 1 /f',
        'reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Uninstall" /v "NoRemove" /t REG_DWORD /d 1 /f',
        ...
        'reg add "HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\Windows Application Experience" /v "UI" /t REG_DWORD /d 0 /f',
        'reg add "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Uninstall\Driver" /v "Video" /t REG_DWORD /d 2 /f',
